...
php vendor\bin\ecs check vendor/markocupic/contao-theme-sac-pilatus/symlink_stuff/templates --fix --config vendor/markocupic/contao-theme-sac-pilatus/tools/ecs/config.php
